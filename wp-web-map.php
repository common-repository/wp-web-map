...
function wpwmap_custom_admin_styles() {
    wp_enqueue_style('wpwmapPluginStylesheet', plugins_url('/css/wp-web-map.css', __FILE__ ));
	}
 add_action('admin_enqueue_scripts', 'wpwmap_custom_admin_styles');  
...
add_options_page( 'wp web map', 'WP Web Map', 'manage_options', 'wpwmap_checking', 'wpwmap_checking_options_page' );
...
register_setting( 'wpwmap_option', 'wpwmap_chec_settings' );

add_settings_section(
    'wpwmap_chec_checking_section', 
...
$options = get_option( 'wpwmap_chec_settings' );
?>
<input type='checkbox' name='wpwmap_chec_settings[wpwmap_chec_checkbox_field_0]' <?php checked( $options['wpwmap_chec_checkbox_field_0'], true ); ?> value='1'>
<?php
...
$options = get_option( 'wpwmap_chec_settings' );
?>
<input type='checkbox' name='wpwmap_chec_settings[wpwmap_chec_checkbox_field_1]' <?php checked( $options['wpwmap_chec_checkbox_field_1'], true ); ?> value='1'>
<?php
...
$options = get_option( 'wpwmap_chec_settings' );
if (! $options['wpwmap_chec_checkbox_field_0'] == '1' ) {
...
$options = get_option( 'wpwmap_chec_settings' );
if (! $options['wpwmap_chec_checkbox_field_1'] == '1' ) {
...
<form action='options.php' method='post'>
    ...
    <?php
    settings_fields( 'wpwmap_option' );
    do_settings_sections( 'wpwmap_checking' );
    submit_button();
    ?>
